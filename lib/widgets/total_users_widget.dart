...
class TotalUsersWidget extends StatefulWidget {
  const TotalUsersWidget({ Key? key }) : super(key: key);

  @override
  _TotalUsersWidgetState createState() => _TotalUsersWidgetState();
}

class _TotalUsersWidgetState extends State<TotalUsersWidget> {
  @override
